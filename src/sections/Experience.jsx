...
export function Experience() {
  return (
    <section id="experience" className="py-24 relative bg-page">
          ...
          <div className="space-y-12">
            {experience.map((exp, i) => (
              ...
              >
                ...
                <div className="md:w-1/2 md:pl-12 ml-11 md:ml-0">
                  <div className="p-5 rounded-xl bg-card border border-[var(--border-subtle)] shadow-card">
                    <h4 className="font-semibold text-[var(--text-primary)] mb-2">{exp.role}</h4>
